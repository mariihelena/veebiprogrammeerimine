<?php
	...
	function listIdeas(){
		...
		while($stmt->fetch()){
			...
			//<p style="backround-color: #ffff80">Kõike saab paremini seletada!</p>
//<p style-"backround-color: #ffff80">Kõike saab paremini seletada! | <a href="edituseridea.php?id=4">Toimeta</a></p>
		}
